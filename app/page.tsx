...
type Category = "Work" | "Personal" | "Health" | "Career";
type DueOption = "Today" | "Tomorrow" | "This Week";
type TabOption = "all" | "active" | "done" | "focus";
type SortOption = "priority" | "status" | "alphabetical";
  ...
  const filteredTasks = useMemo(() => {
    const list = [...tasks].filter((task) => {
      ...
      const matchesQuery =
        ...
        task.tags.join(" ").toLowerCase().includes(searchText);
          ...
          >
            <div>
              ...
              <p className={`mt-2 max-w-2xl text-sm md:text-base ${muted}`}>
                A polished productivity dashboard with smart filters, performance
                stats, task planning, and a bold red-black aesthetic.
              </p>
            </div>
              ...
              <Card className={`${panel} border shadow-xl`}>
                <CardHeader>
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                      <CardTitle className="text-2xl text-white font-bold tracking-wide drop-shadow-[0_0_6px_rgba(255,0,0,0.6)]">
                        Task Workspace
                      </CardTitle>
                      <CardDescription className={muted}>
                        Search, filter, sort, and manage everything in one place.
                      </CardDescription>
                    </div>

                    <Tabs value={tab} onValueChange={(value) => setTab(value as TabOption)}>
                          ...
                          <div className="flex gap-4">
                            ...
                            <div>
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                <Badge className={priorities[task.priority]}>
                                  {task.priority}
                                </Badge>
                              ...
                              <div className="mt-3 flex flex-wrap gap-2 text-xs">
                                {task.tags.map((tag) => (
                                  <span
                                    key={tag}
                                    className="rounded-full border border-red-900/40 bg-red-950/30 px-2.5 py-1 text-red-200"
                                  >
                                    #{tag}
                                  </span>
                                ))}
            ...
            <div className="space-y-6">
              <Card className={`${panel} border shadow-xl`}>
                <CardHeader>
                  ...
                  <CardDescription className={muted}>
                    Add a new task with category, priority, and due timing.
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <Select
                      ...
                      onValueChange={(value) =>
                        setNewTask({ ...newTask, category: value as Category })
                      }
                    >
                      <SelectTrigger className="border-red-950 bg-zinc-900 text-white">
                        <SelectValue />
                    ...
                    <Select
                      value={newTask.due}
                      onValueChange={(value) =>
                        setNewTask({ ...newTask, due: value as DueOption })
                      }
                    >
                      <SelectTrigger className="border-red-950 bg-zinc-900 text-white">
                        <SelectValue />
              ...
              <Card className={`${panel} border shadow-xl`}>
                <CardHeader>
                  ...
                  <CardDescription className={muted}>
                    Track your momentum at a glance.
                  </CardDescription>
                </CardHeader>
              ...
              <Card className={`${panel} border shadow-xl`}>
                <CardHeader>
                  ...
                  <CardDescription className={muted}>
                    A stylish breakdown of what needs attention.
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  {[
                    ...
                    <div
                      key={row.label}
                      className="rounded-2xl border border-zinc-900 bg-black/40 p-4"
                    >
